...
/**
 * Create a Farcaster profile URL from FID or username
 * @param {number} fid - Farcaster ID
 * @param {string} username - Optional username (preferred over FID)
 * @returns {string} - Profile URL
 */
export function getProfileUrl(fid, username = null) {
  if (username) {
