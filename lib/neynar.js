...
export async function fetchMiniappRankings(apiKey) {
  try {
    ...
    console.log('[NEYNAR] Full response keys:', Object.keys(data));
    console.log('[NEYNAR] First frame sample:', data?.frames?.[0] ? JSON.stringify(data.frames[0], null, 2) : 'No frames');
