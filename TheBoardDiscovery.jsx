...
const DailyClaim = ({ isInFarcaster = false, userFid = null, isConnected = false, featuredApp = null, hasClickedMiniapp = false, neynarUserScore = null }) => {
  const MIN_NEYNAR_SCORE = 0.51; // Minimum Neynar user score required to claim
        ...
        {neynarUserScore !== null && neynarUserScore < MIN_NEYNAR_SCORE ? (
          ...
          <>
            ...
            {hasClickedMiniapp && isInFarcaster && !isConnected && (
              <div className="mb-4 p-3 border border-white/50 bg-white/5">
                <div className="text-[10px] tracking-[0.2em] text-white text-center">
